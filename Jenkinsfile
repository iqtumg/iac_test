pipeline {
  agent any
  environment {
    CLIENT = credentials('edcd9ff6-fa78-48b6-ab0b-5f02c2145fc5')
    TENANT = credentials('bd177737-dc9f-49d5-89fa-af1c0232bfc9')
    SECRET = credentials('_ZX8Q~YOFThPgRoHxaqUl3a-Hp-xm1~zznbSgcg4')
  }
